 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(n){function e(G,$){var k=G.length;G.push($);e:for(;0<k;){var te=k-1>>>1,he=G[te];if(0<r(he,$))G[te]=$,G[k]=he,k=te;else break e}}function t(G){return G.length===0?null:G[0]}function i(G){if(G.length===0)return null;var $=G[0],k=G.pop();if(k!==$){G[0]=k;e:for(var te=0,he=G.length,le=he>>>1;te<le;){var W=2*(te+1)-1,F=G[W],j=W+1,de=G[j];if(0>r(F,k))j<he&&0>r(de,F)?(G[te]=de,G[j]=k,te=j):(G[te]=F,G[W]=k,te=W);else if(j<he&&0>r(de,k))G[te]=de,G[j]=k,te=j;else break e}}return $}function r(G,$){var k=G.sortIndex-$.sortIndex;return k!==0?k:G.id-$.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;n.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();n.unstable_now=function(){return o.now()-a}}var l=[],c=[],f=1,h=null,u=3,m=!1,x=!1,_=!1,g=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,v=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function y(G){for(var $=t(c);$!==null;){if($.callback===null)i(c);else if($.startTime<=G)i(c),$.sortIndex=$.expirationTime,e(l,$);else break;$=t(c)}}function S(G){if(_=!1,y(G),!x)if(t(l)!==null)x=!0,H(w);else{var $=t(c);$!==null&&Z(S,$.startTime-G)}}function w(G,$){x=!1,_&&(_=!1,p(P),P=-1),m=!0;var k=u;try{for(y($),h=t(l);h!==null&&(!(h.expirationTime>$)||G&&!R());){var te=h.callback;if(typeof te=="function"){h.callback=null,u=h.priorityLevel;var he=te(h.expirationTime<=$);$=n.unstable_now(),typeof he=="function"?h.callback=he:h===t(l)&&i(l),y($)}else i(l);h=t(l)}if(h!==null)var le=!0;else{var W=t(c);W!==null&&Z(S,W.startTime-$),le=!1}return le}finally{h=null,u=k,m=!1}}var T=!1,E=null,P=-1,U=5,b=-1;function R(){return!(n.unstable_now()-b<U)}function q(){if(E!==null){var G=n.unstable_now();b=G;var $=!0;try{$=E(!0,G)}finally{$?re():(T=!1,E=null)}}else T=!1}var re;if(typeof v=="function")re=function(){v(q)};else if(typeof MessageChannel<"u"){var O=new MessageChannel,ne=O.port2;O.port1.onmessage=q,re=function(){ne.postMessage(null)}}else re=function(){g(q,0)};function H(G){E=G,T||(T=!0,re())}function Z(G,$){P=g(function(){G(n.unstable_now())},$)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(G){G.callback=null},n.unstable_continueExecution=function(){x||m||(x=!0,H(w))},n.unstable_forceFrameRate=function(G){0>G||125<G?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):U=0<G?Math.floor(1e3/G):5},n.unstable_getCurrentPriorityLevel=function(){return u},n.unstable_getFirstCallbackNode=function(){return t(l)},n.unstable_next=function(G){switch(u){case 1:case 2:case 3:var $=3;break;default:$=u}var k=u;u=$;try{return G()}finally{u=k}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(G,$){switch(G){case 1:case 2:case 3:case 4:case 5:break;default:G=3}var k=u;u=G;try{return $()}finally{u=k}},n.unstable_scheduleCallback=function(G,$,k){var te=n.unstable_now();switch(typeof k=="object"&&k!==null?(k=k.delay,k=typeof k=="number"&&0<k?te+k:te):k=te,G){case 1:var he=-1;break;case 2:he=250;break;case 5:he=1073741823;break;case 4:he=1e4;break;default:he=5e3}return he=k+he,G={id:f++,callback:$,priorityLevel:G,startTime:k,expirationTime:he,sortIndex:-1},k>te?(G.sortIndex=k,e(c,G),t(l)===null&&G===t(c)&&(_?(p(P),P=-1):_=!0,Z(S,k-te))):(G.sortIndex=he,e(l,G),x||m||(x=!0,H(w))),G},n.unstable_shouldYield=R,n.unstable_wrapCallback=function(G){var $=u;return function(){var k=u;u=$;try{return G.apply(this,arguments)}finally{u=k}}}})(wx);Mx.exports=wx;var G1=Mx.exports;/**
 * @license React
...
`)+`
`+v);const S=y+p+o,w=y+v+a,T=u0(r,r.VERTEX_SHADER,S),E=u0(r,r.FRAGMENT_SHADER,w);r.attachShader(g,T),r.attachShader(g,E),t.index0AttributeName!==void 0?r.bindAttribLocation(g,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(g,0,"position"),r.linkProgram(g);function P(q){if(n.debug.checkShaderErrors){const re=r.getProgramInfoLog(g).trim(),O=r.getShaderInfoLog(T).trim(),ne=r.getShaderInfoLog(E).trim();let H=!0,Z=!0;if(r.getProgramParameter(g,r.LINK_STATUS)===!1)if(H=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,g,T,E);else{const G=f0(r,T,"vertex"),$=f0(r,E,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(g,r.VALIDATE_STATUS)+`
...
</html>`;e.document.open(),e.document.write(f),e.document.close()}const vh="cosmo_app_saved_state_v2",i3=()=>{try{const n=localStorage.getItem(vh);if(n)return JSON.parse(n)}catch(n){console.error("Failed to load state from localStorage",n)}return null},Mt=i3(),r3=[{id:"01_full_constellation",title:"01. Полная штатная группировка"},{id:"02_first_launch",title:"02. Первый этап запуска"},{id:"03_satellite_outages",title:"03. Моделирование отказов"},{id:"04_link_range",title:"04. Тестирование дальности ISL"}],s3={showOrbits:!0,showSatellites:!0,showGateways:!0,showGatewayCoverage:!0,showISL:!0,showSatLinks:!0,showLabels:!0,showAtmosphere:!0,showCoverageHeatmap:!0,showDistances:!1,satGlow:!0,satSize:1,orbitOpacity:.5,stepSeconds:1,satColor:"#ffffff",offlineSatColor:"#ef4444",highLatencySatColor:"#f59e0b",orbitColor:"#64748b",islColor:"#cbd5e1",gatewayColor:"#e2e8f0",groundLinkColor:"#94a3b8",atmosphereColor:"#1e293b",fovConeColor:"#ffffff",planeRaanMap:{},planePhaseMap:{},planeIncMap:{},planeAltMap:{},hiddenPlanes:{},hiddenSatellites:{},hiddenGateways:{},offlineGateways:{}},o3={map2d:{isOpen:!1,zIndex:9},analytics:{isOpen:!1,zIndex:10},configurator:{isOpen:!1,zIndex:11},compare:{isOpen:!1,zIndex:12},emergency:{isOpen:!1,zIndex:13},scenarios:{isOpen:!1,zIndex:14},satellite_detail:{isOpen:!1,zIndex:15},recommendations:{isOpen:!1,zIndex:16}},a3=()=>{var Oe,Fe,oe,me,A,M,X,z,K,V,ve;const[n,e]=xe.useState((Mt==null?void 0:Mt.scenarios)||r3),[t,i]=xe.useState((Mt==null?void 0:Mt.activeScenarioId)||"01_full_constellation"),[r,s]=xe.useState(null),[o,a]=xe.useState((Mt==null?void 0:Mt.currentRawScenario)||null),[l,c]=xe.useState(!1),[f,h]=xe.useState((Mt==null?void 0:Mt.isSidebarOpen)??!0),[u,m]=xe.useState((Mt==null?void 0:Mt.currentTimeSeconds)||0),[x,_]=xe.useState("3d"),[g,p]=xe.useState(null),[v,y]=xe.useState((Mt==null?void 0:Mt.currentOutages)||[]),[S,w]=xe.useState(null),[T,E]=xe.useState([]),[P,U]=xe.useState(()=>{const D=(Mt==null?void 0:Mt.outlinerSettings)||{};return{...s3,...D,planeRaanMap:D.planeRaanMap||{},planePhaseMap:D.planePhaseMap||{},planeIncMap:D.planeIncMap||{},planeAltMap:D.planeAltMap||{},hiddenPlanes:D.hiddenPlanes||{},hiddenSatellites:D.hiddenSatellites||{},hiddenGateways:D.hiddenGateways||{},offlineGateways:D.offlineGateways||{},satColor:D.satColor||"#ffffff",offlineSatColor:D.offlineSatColor||"#e11d48",highLatencySatColor:D.highLatencySatColor||"#d97706",orbitColor:D.orbitColor||"#475569",islColor:D.islColor||"#cbd5e1",gatewayColor:D.gatewayColor||"#f8fafc",groundLinkColor:D.groundLinkColor||"#94a3b8",atmosphereColor:D.atmosphereColor||"#334155",fovConeColor:D.fovConeColor||"#cbd5e1"}}),[b,R]=xe.useState(()=>{const D={...(Mt==null?void 0:Mt.windows)||{}};return delete D.mass_sim,{...o3,...D}}),[q,re]=xe.useState(20),[O,ne]=xe.useState([{id:"1",time:new Date().toLocaleTimeString("ru-RU"),text:"Ядро системы визуализации успешно запущено",type:"info"},{id:"2",time:new Date().toLocaleTimeString("ru-RU"),text:"Подключен математический модуль динамики орбит",type:"success"}]),H=xe.useCallback((D,Y="info")=>{const ie={id:Date.now().toString(),time:new Date().toLocaleTimeString("ru-RU"),text:D,type:Y};ne(ge=>[...ge.slice(-49),ie])},[]);xe.useEffect(()=>{try{const D={scenarios:n,activeScenarioId:t,currentRawScenario:o,outlinerSettings:P,windows:b,currentOutages:v,currentTimeSeconds:u,isSidebarOpen:f};localStorage.setItem(vh,JSON.stringify(D))}catch(D){console.error("Failed to save state to localStorage",D)}},[n,t,o,P,b,v,u,f]);const Z=()=>{try{localStorage.removeItem(vh),H("Сохраненное состояние очищено! Перезагрузка страницы...","warning"),setTimeout(()=>{window.location.reload()},400)}catch(D){console.error("Failed to reset state",D)}},G=xe.useCallback(async D=>{var Y;try{H(`Загрузка сценария: ${D}`,"info");const ie=await fetch(`/api/simulate?scenario_id=${D}`);if(ie.ok){const ge=await ie.json();s(ge),ge.raw_scenario&&a(ge.raw_scenario),H(`Карта и расчет перестроены для '${ge.title}': ${((Y=ge.satellites)==null?void 0:Y.length)||0} аппаратов`,"success")}else $(D)}catch{$(D)}},[H]);xe.useEffect(()=>{if(!r||!r.satellites)return;const D=r.satellites.filter(ie=>(ie.temperature_c??35)>=80),Y=r.satellites.filter(ie=>(ie.fuel_pct??100)<=15);D.length>0&&D.forEach(ie=>{H(`[КРИТИЧЕСКИЙ ПЕРЕГРЕВ] КА [${ie.id}]: T=${ie.temperature_c??84}°C (превышение порога 80°C)!`,"error")}),Y.length>0&&Y.forEach(ie=>{H(`[КРИТИЧЕСКИЙ ОСТАТОК ТОПЛИВА] КА [${ie.id}]: остаток ксенона ${ie.fuel_kg??1.2} кг (${ie.fuel_pct??12}% <= 15%)!`,"warning")})},[r,H]);const $=D=>{const ie=D.includes("02")||D.includes("first_launch")?16:48,ge=[];for(let De=0;De<ie;De++){const Me=Math.floor(De/8),be=De%8,Se=(De+1).toString().padStart(2,"0");ge.push({id:`S${Se}`,plane:Me+1,idx:be,altitude:600,inc:86.4,raan:Me*60,arg_per:0,true_anomaly:be*45,sub_lat:Math.sin(be*45*Math.PI/180)*80,sub_lon:(Me*60+be*45)%360-180})}const Q=[{id:"C65",name:"Центральный Шлюз C65",lat:55.75,lon:37.61,type:"gateway"},{id:"C70",name:"Шлюз C70",lat:59.93,lon:30.31,type:"gateway"},{id:"Murmansk",name:"Мурманск",lat:68.97,lon:33.08,type:"gateway"},{id:"Pechora",name:"Печора",lat:65.14,lon:57.22,type:"gateway"}];s({scenario_id:D,title:"Штатный Сценарий Группировки",description:"Сгенерированная геометрия 48 спутников",timestamp_utc:new Date().toISOString(),satellites:ge,gateways:Q,routes_sample:[{src:"C65",dst:"Murmansk",path:["C65","S01","S09","S17","Murmansk"],latency_ms:38.4,status:"АКТИВЕН"},{src:"C65",dst:"Pechora",path:["C65","S02","S10","Pechora"],latency_ms:29.1,status:"АКТИВЕН"}]}),H("Локальная геометрия сгенерирована: 48 спутников, 4 шлюза","info")};xe.useEffect(()=>{G(t)},[t,G]);const k=async D=>{var ie;H("Загрузка базового сценария для Монте-Карло анализа...","info"),a(D);const Y=((ie=D.meta)==null?void 0:ie.title)||"Загруженный Сценарий";e(ge=>{var De;const Q=((De=D.meta)==null?void 0:De.id)||"custom_upload";return ge.some(Me=>Me.id===Q)?ge:[...ge,{id:Q,title:Y}]}),Ae("compare"),H("Запущен расчет комбинаций Монте-Карло... Ожидайте результаты в таблице.","success")},te=(D,Y)=>{var Q;H(`Анализ сценария "${(Q=D.meta)==null?void 0:Q.title}" загружается на 3D карту...`,"success"),a(D);const ie=Y&&Y.satellites&&Y.satellites.length>0&&Y.gateways;ie&&s(Y);const ge=D.failures||[];y(ge),ie||j(ge),Ae("analytics")},he=async D=>{var Me;H(`Генерация новой космической группировки (${D.planes}x${D.satsPerPlane} @ ${D.altitude}км)...`,"info"),c(!0);const Y=[],ie=[],ge=[];let Q=1;for(let be=0;be<D.planes;be++){const Se=`P${be+1}`,Le=ca(be*(360/D.planes)%360,1),L=ca(be*(360/(D.planes*D.satsPerPlane))%360,1);Y.push({id:Se,raan_deg:Le,phase_deg:L});for(let fe=0;fe<D.satsPerPlane;fe++){const Re=`S${Q.toString().padStart(2,"0")}`,I=ca(fe*(360/D.satsPerPlane)%360,1);ie.push({id:Re,plane_id:Se,slot_deg:I,launch_batch:1});const ye=Math.sin(I*Math.PI/180)*(D.inclination*.9),J=(Le+I)%360-180;ge.push({id:Re,plane:be+1,idx:fe,altitude:D.altitude,inc:D.inclination,raan:Le,arg_per:0,true_anomaly:I,sub_lat:ca(ye,4),sub_lon:ca(J,4)}),Q++}}const De={schema_version:"cosmo-A-1.0",meta:{id:"custom_walker_config",title:`Walker Delta ${D.planes}x${D.satsPerPlane} (${ie.length} аппаратов)`},environment:{altitude_km:D.altitude,inclination_deg:D.inclination,earth_angle0_deg:12,horizon_s:86400,step_s:120,min_elevation_deg:D.minElevation,isl_range_km:3e3,target_availability:.9},design:{launch_stage:3,planes:Y,satellites:ie},ground_sites:[{id:"C65",name:"Центральный Шлюз C65",role:"gateway",lat_deg:55.75,lon_deg:37.61},{id:"C70",name:"Шлюз C70",role:"gateway",lat_deg:59.93,lon_deg:30.31},{id:"Murmansk",name:"Мурманск (Клиент)",role:"client",lat_deg:68.97,lon_deg:33.08},{id:"Pechora",name:"Печора (Клиент)",role:"client",lat_deg:65.14,lon_deg:57.22}],failures:v.map(be=>({satellite_id:be.satellite_id,start_s:be.start_s,end_s:be.end_s})),gateway_outages:[]};try{const be=await fetch("/api/simulate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({scenario:De})});if(be.ok){const Se=await be.json();s(Se),a(De),H(`Карта и расчет новой группировки зафиксированы! Общая доступность ${((((Me=Se.simulation_result)==null?void 0:Me.overall_availability)||.99)*100).toFixed(2)}%`,"success"),Ae("analytics")}else s({scenario_id:"custom_config",title:`Walker Delta ${D.planes}x${D.satsPerPlane}`,description:`Конфигурация ${D.planes}x${D.satsPerPlane} @ ${D.altitude}км`,timestamp_utc:new Date().toISOString(),satellites:ge,gateways:[{id:"C65",name:"Центральный Шлюз C65",lat:55.75,lon:37.61,type:"gateway"},{id:"Murmansk",name:"Мурманск",lat:68.97,lon:33.08,type:"gateway"}],routes_sample:[{src:"C65",dst:"Murmansk",path:["C65","S01","S02","Murmansk"],latency_ms:36.2,status:"АКТИВЕН"}]}),H(`3D-карта перестроена (${ge.length} аппаратов)`,"info")}catch{s({scenario_id:"custom_config",title:`Walker Delta ${D.planes}x${D.satsPerPlane}`,description:`Конфигурация ${D.planes}x${D.satsPerPlane} @ ${D.altitude}км`,timestamp_utc:new Date().toISOString(),satellites:ge,gateways:[{id:"C65",name:"Центральный Шлюз C65",lat:55.75,lon:37.61,type:"gateway"},{id:"Murmansk",name:"Мурманск",lat:68.97,lon:33.08,type:"gateway"}],routes_sample:[{src:"C65",dst:"Murmansk",path:["C65","S01","S02","Murmansk"],latency_ms:36.2,status:"АКТИВЕН"}]}),H(`3D-карта перестроена под конфигурацию (${ge.length} аппаратов)`,"info")}finally{c(!1)}},le=()=>{const D=o||{schema_version:"cosmo-A-1.0",meta:{id:t,title:(r==null?void 0:r.title)||"Сценарий Группировки"},environment:{altitude_km:550,inclination_deg:87,earth_angle0_deg:12,horizon_s:86400,step_s:120,min_elevation_deg:10,isl_range_km:3e3,target_availability:.9},satellites:r==null?void 0:r.satellites,gateways:r==null?void 0:r.gateways},Y=JSON.stringify(D,null,2),ie=new Blob([Y],{type:"application/json"}),ge=URL.createObjectURL(ie),Q=document.createElement("a");Q.href=ge,Q.download=`scenario_${t}_export.json`,Q.click(),URL.revokeObjectURL(ge),H("Итоговый сценарий экспортирован в JSON (cosmo-A-1.0)","success")},W=()=>{if(!r||!r.raw_scenario||!r.simulation_result){H("Нет полных данных симуляции для экспорта","warning");return}const D=[];if(r.simulation_result.routes_by_time)for(const Me of r.simulation_result.routes_by_time){const be=Me.t_s;for(const[Se,Le]of Object.entries(Me.routes||{}))D.push({t_s:be,client_id:Se,path:Le})}const Y={schema_version:"cosmo-A-result-1.0",effective_scenario:r.raw_scenario,routes:D},ie=JSON.stringify(Y,null,2),ge=new Blob([ie],{type:"application/json"}),Q=URL.createObjectURL(ge),De=document.createElement("a");De.href=Q,De.download=`cosmo-A-result-1.0_${t}.json`,De.click(),URL.revokeObjectURL(Q),H("Итоговые результаты моделирования экспортированы в формате cosmo-A-result-1.0","success")},F=D=>{if(!D){p(null),w(null);return}p(D.id),w(D),H(`Камера сфокусирована на спутнике [${D.id}]. Отображается 3D-конус угла обзора (10°)`,"info")},j=async(D,Y=P.planeRaanMap,ie=P.planePhaseMap)=>{var ge;c(!0);try{const Q=o?JSON.parse(JSON.stringify(o)):{schema_version:"cosmo-A-1.0",meta:{id:t,title:(r==null?void 0:r.title)||"Сценарий"},environment:{altitude_km:550,inclination_deg:87,earth_angle0_deg:12,horizon_s:86400,step_s:120,min_elevation_deg:10,isl_range_km:3e3,target_availability:.9},design:{launch_stage:3,planes:[{id:"P1",raan_deg:0,phase_deg:0},{id:"P2",raan_deg:60,phase_deg:15},{id:"P3",raan_deg:120,phase_deg:30},{id:"P4",raan_deg:180,phase_deg:45},{id:"P5",raan_deg:240,phase_deg:60},{id:"P6",raan_deg:300,phase_deg:75}],satellites:((r==null?void 0:r.satellites)||[]).map(Me=>({id:Me.id,plane_id:`P${Me.plane}`,slot_deg:Me.idx,launch_batch:1}))},ground_sites:[{id:"C65",name:"Центральный Шлюз C65",role:"gateway",lat_deg:55.75,lon_deg:37.61},{id:"C70",name:"Шлюз C70",role:"gateway",lat_deg:59.93,lon_deg:30.31},{id:"Murmansk",name:"Мурманск (Клиент)",role:"client",lat_deg:68.97,lon_deg:33.08},{id:"Pechora",name:"Печора (Клиент)",role:"client",lat_deg:65.14,lon_deg:57.22}]};(ge=Q.design)!=null&&ge.planes&&(Q.design.planes=Q.design.planes.map(Me=>{const be=parseInt(String(Me.id).replace("P",""))||1,Se=Y[be]??0,Le=ie[be]??0;return{...Me,raan_deg:Math.round((((Me.raan_deg??0)+Se)%360+360)%360*10)/10,phase_deg:Math.round((((Me.phase_deg??0)+Le)%360+360)%360*10)/10}})),Q.failures=D.map(Me=>({satellite_id:Me.satellite_id,start_s:Me.start_s,end_s:Me.end_s}));const De=await fetch("/api/simulate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({scenario:Q})});if(De.ok){const Me=await De.json();s(Me),a(Q)}}catch(Q){console.error(Q)}finally{c(!1)}};xe.useEffect(()=>{if(!r)return;const D=setTimeout(()=>{j(v,P.planeRaanMap,P.planePhaseMap)},250);return()=>clearTimeout(D)},[P.planeRaanMap,P.planePhaseMap]);const de=(D,Y)=>{const ie={satellite_id:D,start_s:u,end_s:u+Y},ge=[...v.filter(Q=>Q.satellite_id!==D),ie];y(ge),w(null),H(`Спутник [${D}] выведен из строя на ${Y}с! Вся топология пересчитана.`,"warning"),j(ge)},ue=D=>{const Y=v.filter(ie=>ie.satellite_id!==D);y(Y),w(null),H(`Работа спутника [${D}] успешно восстановлена`,"success"),j(Y)},pe=D=>{y(D),j(D)},Ie=()=>{y([]),j([])},we=D=>{D==="phase_shift"?(U(Y=>({...Y,planePhaseMap:{...Y.planePhaseMap,1:(Y.planePhaseMap[1]||0)+15}})),H("Применена рекомендация: Выполнен фазовый сдвиг (+15°) для плоскости P1","success")):D==="reroute_isl"&&(B(),H("Применена рекомендация: Перестроена графовая маршрутизация ISL линий","success"))},B=async()=>{var D;c(!0),H("Запуск полного математического моделирования...","info");try{if(o)await k(o);else{const Y=await fetch(`/api/simulate?scenario_id=${t}`);if(Y.ok){const ie=await Y.json();s(ie),H(`Моделирование завершено: Общая доступность ${((((D=ie.simulation_result)==null?void 0:D.overall_availability)||.9998)*100).toFixed(2)}%`,"success")}}}catch{H("Ошибка при вычислении симуляции","error")}finally{c(!1),Ae("analytics")}},Be=D=>{e(Y=>Y.filter(ie=>ie.id!==D)),H(`Сценарий '${D}' удален из списка`,"warning")},Ae=D=>{const Y=q+1;re(Y),R(ie=>({...ie,[D]:{isOpen:!0,zIndex:Y}})),H(`Открыто окно: ${D}`,"info")},Pe=D=>{R(Y=>({...Y,[D]:{...Y[D],isOpen:!1}}))},Ce=D=>{const Y=q+1;re(Y),R(ie=>({...ie,[D]:{...ie[D],zIndex:Y}}))};return d.jsxs("div",{style:{width:"100vw",height:"100vh",display:"flex",flexDirection:"column",backgroundColor:"#1a1a1a",overflow:"hidden"},children:[d.jsx(Cb,{scenarios:n,activeScenario:t,onSelectScenario:D=>i(D),onRunSimulation:B,onOpenWindow:Ae,onToggleSidebar:()=>h(!f),onUploadScenarioJson:k,onExportScenarioJson:le,onExportResultsJson:W,onOpenPdfReport:()=>sf(r),onResetState:Z,viewMode:x,onToggleViewMode:_,isSidebarOpen:f,isSimulating:l}),d.jsxs("div",{style:{flex:1,position:"relative",display:"flex",overflow:"hidden"},children:[d.jsxs("div",{style:{flex:1,position:"relative",overflow:"hidden"},children:[d.jsx(Pb,{settings:P,onChangeSettings:U}),g&&d.jsxs("button",{onClick:()=>p(null),style:{position:"absolute",top:"16px",left:"68px",zIndex:86,backgroundColor:"#1473e6",color:"#ffffff",border:"none",borderRadius:"6px",padding:"7px 12px",fontSize:"12px",fontWeight:600,cursor:"pointer",display:"flex",alignItems:"center",gap:"6px",boxShadow:"0 4px 14px rgba(0,0,0,0.5)",transition:"all 0.15s ease"},children:[d.jsx(Ka,{size:14}),d.jsx("span",{children:"Сбросить фокус камеры (Вся Земля)"})]}),d.jsx(qR,{scenario:r,currentTimeSeconds:u,onSelectSatellite:F}),x==="3d"?d.jsx(FR,{scenario:r,settings:P,currentTime:u,outages:v,criticalSatellites:T,focusedSatelliteId:g,onSelectSatellite:F}):d.jsx(e3,{scenario:r,settings:P,currentTime:u,outages:v,onSelectSatellite:D=>{const Y=r==null?void 0:r.satellites.find(ie=>ie.id===D);Y&&w(Y)}}),d.jsx(KR,{currentTime:u,maxTime:86400,stepSeconds:P.stepSeconds,onChangeStep:D=>U(Y=>({...Y,stepSeconds:D})),onChangeTime:m})]}),f&&d.jsx(Rb,{settings:P,onChangeSettings:U,isOpen:f,scenario:r,focusedSatelliteId:g,onSelectSatellite:F}),d.jsx(Yr,{id:"satellite_detail",title:`Управление и Трафик Спутника ${(S==null?void 0:S.id)||""}`,isOpen:!!S,onClose:()=>w(null),zIndex:((Oe=b.satellite_detail)==null?void 0:Oe.zIndex)||15,onFocus:()=>Ce("satellite_detail"),initialPos:{x:120,y:80,width:460,height:490},children:d.jsx(ZR,{satellite:S,activeRoutePath:(oe=(Fe=r==null?void 0:r.routes_sample)==null?void 0:Fe.find(D=>S&&D.path.includes(S.id)))==null?void 0:oe.path,currentOutages:v,currentTimeSeconds:u,onClose:()=>w(null),onApplyOutage:de,onRestoreSatellite:ue})}),d.jsx(Yr,{id:"analytics",title:"Аналитика Группировки & Рекомендации Регламента",isOpen:b.analytics.isOpen,onClose:()=>Pe("analytics"),zIndex:b.analytics.zIndex,onFocus:()=>Ce("analytics"),initialPos:{x:60,y:60,width:880,height:560},children:d.jsx(GR,{scenario:r,outages:v,currentTime:u,onApplyRecommendation:we,onExportResultsJson:W,onOpenPdfReport:()=>sf(r)})}),d.jsx(Yr,{id:"configurator",title:"Конфигуратор Параметров Группировки",isOpen:b.configurator.isOpen,onClose:()=>Pe("configurator"),zIndex:b.configurator.zIndex,onFocus:()=>Ce("configurator"),initialPos:{x:180,y:90,width:680,height:460},children:d.jsx(WR,{onApplyConfig:he,onExportJson:le})}),d.jsx(Yr,{id:"compare",title:"Анализ Комбинаций Отказов и Сравнение",isOpen:(me=b.compare)==null?void 0:me.isOpen,onClose:()=>Pe("compare"),zIndex:((A=b.compare)==null?void 0:A.zIndex)||12,onFocus:()=>Ce("compare"),initialPos:{x:100,y:100,width:900,height:600},children:d.jsx($R,{onOpenConfigurator:()=>Ae("configurator"),baseScenario:o,onVisualizeScenario:te,onClose:()=>Pe("compare"),onSetCriticalSatellites:E})}),d.jsx(JR,{isOpen:(M=b.emergency)==null?void 0:M.isOpen,onClose:()=>Pe("emergency"),zIndex:((X=b.emergency)==null?void 0:X.zIndex)||13,onFocusWindow:()=>Ce("emergency"),currentOutages:v,outlinerSettings:P,onApplyOutageBatch:pe,onClearOutages:Ie,onUpdateSettings:U,onAddLog:H}),d.jsx(Yr,{id:"scenarios",title:"Менеджер и Библиотека Сценариев",isOpen:(z=b.scenarios)==null?void 0:z.isOpen,onClose:()=>Pe("scenarios"),zIndex:((K=b.scenarios)==null?void 0:K.zIndex)||14,onFocus:()=>Ce("scenarios"),initialPos:{x:120,y:70,width:780,height:520},children:d.jsx(QR,{scenarios:n,activeScenarioId:t,onSelectScenario:D=>i(D),onUploadScenarioJson:k,onDeleteScenario:Be,onExportScenarioJson:le,onOpenConfigurator:()=>Ae("configurator")})}),d.jsx(Yr,{id:"recommendations",title:"Инженерные Рекомендации и Авто-Оптимизация Группировки",isOpen:(V=b.recommendations)==null?void 0:V.isOpen,onClose:()=>Pe("recommendations"),zIndex:((ve=b.recommendations)==null?void 0:ve.zIndex)||17,onFocus:()=>Ce("recommendations"),initialPos:{x:80,y:70,width:940,height:620},children:d.jsx(n3,{scenario:r,outages:v,outlinerSettings:P,onUpdateSettings:D=>U(Y=>({...Y,...D})),onClearOutages:Ie,onOpenWindow:Ae,onOpenPdfReport:()=>sf(r)})}),d.jsx(YR,{logs:O})]})]})};function ca(n,e){const t=Math.pow(10,e);return Math.round(n*t)/t}const dx=document.getElementById("root");dx&&of.createRoot(dx).render(d.jsx(Tc.StrictMode,{children:d.jsx(a3,{})}));
